...
| [`mvp2.md`](./mvp2.md) | MVP2 — Retention/Auto-Delete + HTTP-Delete-Endpoints via **DELETE** (kein Confirm-Pattern) | ✅ v2.0 locked |
...
- MVP2 Implementierung (Retention + HTTP-Delete-Endpoints)
